...
This build now uses a much larger overworld, a player-follow camera, map culling so only visible tiles are drawn, and a minimap in the upper-right corner.
