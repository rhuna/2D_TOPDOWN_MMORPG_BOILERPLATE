...
#include "network/NetworkClient.h" // for RemotePlayer
...
#include "game/quests/QuestSystem.h" // for QuestSystem
...
#include "ui/windows/EquipmentUI.h" // for EquipmentUI
#include "ui/windows/InventoryUI.h" // for InventoryUI
#include "ui/windows/QuestUI.h" // for QuestUI
#include "ui/windows/ShopUI.h"  // for ShopUI
#include "ui/windows/DialogueUI.h"  // for DialogueUI
...
public:
    ...
    void SyncUiStateFromLegacy();
    void ApplyUiStateToLegacy();
...
private:
    ...
    gameplay::UIState uiState_;
    gameplay::UIController uiController_;
    gameplay::UIRenderer uiRenderer_;
};
